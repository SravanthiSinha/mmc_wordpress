  ...
  return (
    <div className="min-h-screen pt-2 bg-brand-background-secondary">
      ...
      <main id="main-content">
              ...
              <div className="max-w-6xl mx-auto">
                <div className="text-center mb-12">
                  <h2 className="text-3xl sm:text-4xl font-serif text-brand-text-primary mb-4">
                    The struggles many women carry
                  </h2>
                </div>
                ...
                <FadeInSection delay={600}>
                  <div className="text-center mt-16 p-8 bg-brand-background-secondary">
                    <p className="text-xl text-brand-text-primary max-w-4xl mx-auto leading-relaxed mb-6">
                      These struggles don’t mean you’re weak—they mean you’ve been navigating immense pressures. Therapy can help you find balance, compassion, and strength.
        ...
        {/* Therapeutic Solution Section (for women's therapy) */}
        {therapeuticSolution && (
          <section id="solution" className="px-4 sm:px-6 lg:px-8 py-16 bg-brand-background-primary">
            <FadeInSection>
              <div className="max-w-6xl mx-auto">
                <div className="text-center mb-12">
                  <h2 className="text-3xl sm:text-4xl font-serif text-brand-text-primary mb-4">
                  ...
                  <p className="text-xl text-brand-text-primary max-w-4xl mx-auto leading-relaxed">
                    {therapeuticSolution}
                  </p>
                </div>
                <div className="text-center">
        ...
        {/* How Therapy Works With Us Section*/}
        {howItWorks && (
            ...
            <FadeInSection>
              <div className="max-w-6xl mx-auto">
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-serif text-brand-text-primary mb-12 text-center">
                  How therapy for women works with us
                </h2>
          ...
          <FadeInSection>
            <div className="relative max-w-6xl mx-auto text-center">
              ...
              <p className="text-xl sm:text-2xl text-brand-text-primary mb-16 max-w-4xl mx-auto leading-relaxed">
                Therapy for women is about creating space for you—a place where your voice, needs, and healing are valued. At Mind Matters Center, we make getting started simple:
              </p>
