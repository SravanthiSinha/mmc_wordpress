              ...
              <div className="max-w-6xl mx-auto">
                ...
                <div className="text-center">
                  <p className="text-xl text-brand-text-primary mb-8 max-w-3xl mx-auto">
                    If these sound familiar, you may be experiencing burnout. With support, recovery is possible.
                  </p>
                  <BookNowCTA />
                </div>
              </div>
          ...
          <FadeInSection>
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl sm:text-4xl font-serif text-brand-text-primary mb-4">
                  The challenges of living with burnout
                </h2>
              </div>
              ...
              <FadeInSection delay={600}>
                <div className="text-center mt-16 p-8 bg-white/50 rounded-2xl backdrop-blur-sm">
                  <p className="text-xl text-brand-text-primary max-w-4xl mx-auto leading-relaxed mb-6">
                    Needing support doesn’t mean you’re weak—it means you’ve been carrying too much for too long. Therapy can help you lighten the load and recover your sense of balance.
                  </p>
                  <BookNowCTA />
                </div>
              </FadeInSection>
          ...
          <FadeInSection>
            <div className="max-w-6xl mx-auto">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-serif text-brand-text-primary mb-12 text-center">
                How {title.toLowerCase()} therapy works with us
              </h2>
