          ...
          <FadeInSection>
            <div className="relative max-w-6xl mx-auto text-center">
              ...
              <p className="text-xl sm:text-2xl text-brand-text-primary mb-16 max-w-4xl mx-auto leading-relaxed">
               You don’t have to stay stuck in the same patterns. Couples & Relationship Therapy can help you and your partner feel heard, supported, and connected again. At Between Therapy, we make it easy to get started:
              </p>
