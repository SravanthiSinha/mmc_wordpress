              ...
              <div className="max-w-6xl mx-auto">
                ...
                <div className="text-center">
                  <p className="text-xl text-brand-text-primary mb-8 max-w-3xl mx-auto">
                   If any of these sound familiar, you’re not alone. Many couples face these struggles—and therapy can help you find your way back to each other.
                  </p>
                  <BookNowCTA />
                </div>
              </div>
              ...
              <FadeInSection delay={600}>
                <div className="text-center mt-16 p-8 bg-white/50 rounded-2xl backdrop-blur-sm">
                  <p className="text-xl text-brand-text-primary max-w-4xl mx-auto leading-relaxed mb-6">
                    Seeking therapy doesn’t mean your relationship is failing—it means you both care enough to strengthen it.
                  </p>
                  <BookNowCTA />
                </div>
              </FadeInSection>
          ...
          <FadeInSection>
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                {therapeuticSolution.map((benefit, index) => (
                  <FadeInSection key={index} delay={index * 100}>
                    <div className="h-full flex items-start p-6 bg-brand-sage/5 rounded-xl hover:shadow-md transition-all duration-300">
                      <div className="w-6 h-6 bg-brand-sage rounded-full mr-4 mt-1 flex-shrink-0"></div>
                      <span className="text-lg text-brand-text-primary font-medium leading-relaxed">
                        {benefit}
                      </span>
                    </div>
          ...
          <FadeInSection>
            <div className="relative max-w-6xl mx-auto text-center">
              ...
              <p className="text-xl sm:text-2xl text-brand-text-primary mb-16 max-w-4xl mx-auto leading-relaxed">
               You don’t have to stay stuck in the same patterns. Couples & Relationship Therapy can help you and your partner feel heard, supported, and connected again. At Mind Matters Center, we make it easy to get started:
              </p>
