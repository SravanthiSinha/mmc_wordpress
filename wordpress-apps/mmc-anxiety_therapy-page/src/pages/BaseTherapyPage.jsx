          ...
          <FadeInSection>
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl sm:text-4xl font-serif text-brand-text-primary mb-4">
                  The challenges of {title.toLowerCase()}
                </h2>
              </div>
              ...
              <FadeInSection delay={600}>
                <div className="text-center mt-16 p-8 bg-white/50 rounded-2xl backdrop-blur-sm">
                  <p className="text-xl text-brand-text-primary max-w-4xl mx-auto leading-relaxed mb-6">
                    These struggles don't mean you're weak. They reflect how deeply stress and emotions affect the mind and body. Therapy can help you find balance and hope again.
                  </p>
                  <BookNowCTA />
                </div>
              </FadeInSection>
