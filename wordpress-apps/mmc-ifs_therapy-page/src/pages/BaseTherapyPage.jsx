            ...
            <FadeInSection>
              <div className="max-w-6xl mx-auto">
                <div className="text-center mb-12">
                  ...
                  <p className="text-xl text-brand-text-primary mb-8">
                ...
                <div className="text-center">
                  <p className="text-xl text-brand-text-primary mb-8 max-w-3xl mx-auto">
                    IFS is not about getting rid of parts of you—it's about listening to them. Healing happens when every part feels heard and understood.
                  </p>
                  <BookNowCTA />
                </div>
              </div>
          ...
          <FadeInSection>
            <div className="relative max-w-6xl mx-auto text-center">
              ...
              <p className="text-xl sm:text-2xl text-brand-text-primary mb-16 max-w-4xl mx-auto leading-relaxed">
                If you're curious about IFS therapy, we invite you to schedule a free consultation. Let's talk about how this approach might support your healing.
              </p>
